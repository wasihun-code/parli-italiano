...
const part1 = [
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Ho il telefono scarico e non posso chiamare nessuno.', 'My phone is dead and I cannot call anyone.', {grammarPoint: 'Adjective "scarico" for electronics.'}],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['L\'orario traghetto è cambiato a causa del mare mosso.', 'The ferry time changed due to rough seas.', {grammarPoint: 'Expression "a causa di".'}],
  ...
  },
  {
    ...
    sentences: [
      ['Il noleggio costa dieci euro e include un\'ora inclusa.', 'The rental costs ten euros and has one included hour.', {grammarPoint: 'Verb "includere".'}],
...
const part2 = [
  ...
  },
  {
    ...
    phrases: [
      ...
      ['Devo fare anche la barra.', 'I need to do my beard too.'],
...
const part4 = [
  {
    ...
    sentences: [
      ...
      ['L\'orario della cena è di solito verso le ott.', 'Dinner time is usually around eight.', {grammarPoint: 'Telling time with "le otto".'}],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['La dose giornaliera è di un misurino di sciroppo.', 'The daily dose is one measuring cup of syrup.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Il principale sintomo è una forte tosse secca.', 'The main symptom is a bad dry cough.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Il paziente ha difficoltà a respirare da solo.', 'The patient has difficulty breathing on his own.'],
      ...
      ['L\'attesa al pronto soccorso può essere lunga.', 'The wait at the emergency room can be long.']
    ]
  },
  {
    id: 96,
    ...
    sentences: [
      ...
      ['Il dentista ha detto che devo curare una carie.', 'The dentist said I need to treat a cavity.'],
      ...
      ['La mia gengiva è sensibile alle bevande fredde.', 'My gum is sensitive to cold drinks.']
    ]
  },
  {
    id: 97,
    ...
    sentences: [
      ...
      ['Il farmaco generico ha lo stesso effetto e costa meno.', 'The generic drug has the same effect and costs less.']
    ]
  },
  {
    id: 98,
    ...
    sentences: [
      ...
      ['Vorrei una SIM ricaricabile con molti dati per navigare.', 'I would like a prepaid SIM with a lot of data for browsing.'],
      ['Questo piano mensile include minuti illimitati.', 'This monthly plan includes unlimited minutes.'],
      ...
      ['Questa compagnia ha un\'ottima copertura in tutta Italia.', 'This company has excellent coverage all over Italy.']
    ]
  },
  {
    id: 99,
    ...
    sentences: [
      ...
      ['Qual è il nome della rete e la password per favore?', 'What is the network name and the password please?'],
      ...
      ['Ho inserito la password ma dice che il codice è errato.', 'I entered the password but it says the code is wrong.']
    ]
  },
  {
    id: 100,
    ...
    sentences: [
      ['Quanto costa la riparazione per un vetro rotto del telefono?', 'How much does the repair cost for a broken phone glass?'],
      ...
      ['Qual è il tempo necessario per cambiare la batteria?', 'What is the time needed to change the battery?']
    ]
  },
  {
    id: 101,
    ...
    sentences: [
      ['Devo caricare il portatile perché la batteria è scarica.', 'I need to charge the laptop because the battery is low.'],
      ...
      ['Ho portato il mio power bank per i lunghi viaggi in treno.', 'I brought my power bank for long train trips.'],
      ['Non posso usare la spina senza un adattatore europeo.', 'I cannot use the plug without a European adapter.'],
      ['C\'è una presa USB disponibile sull\'aereo o in aeroporto?', 'Is there a USB port available on the plane or at the airport?']
    ]
  },
  {
    id: 102,
    ...
    sentences: [
      ...
      ['Devo aggiornare l\'applicazione per avere le ultime mappe.', 'I need to update the application to have the latest maps.']
    ]
  },
  {
    id: 103,
    ...
    sentences: [
      ['Preferisco fare una videochiamata per parlare con la mia famiglia.', 'I prefer to make a video call to talk to my family.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Per entrare al museo, puoi semplicemente mostrare il codice QR.', 'To enter the museum, you can simply show the QR code.'],
      ['Non riesco a fare il pagamento senza accedere al mio account.', 'I cannot make the payment without logging into my account.'],
  ...
  },
  {
    ...
    sentences: [
      ['Vorrei prelevare cinquanta euro dal mio conto corrente.', 'I would like to withdraw fifty euros from my checking account.'],
      ['Può controllare il saldo prima di ritirare i soldi?', 'Can you check the balance before withdrawing the money?'],
      ...
      ['Purtroppo non ci sono abbastanza contanti disponibili in questo momento.', 'Unfortunately there is not enough cash available right now.']
    ]
  },
  {
    id: 106,
    ...
    sentences: [
      ...
      ['Voglio fare una denuncia per un documento perso in stazione.', 'I want to make a report for a document lost at the station.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Ho bisogno di una mano con queste valigie pesanti, per favore.', 'I need a hand with these heavy suitcases, please.'],
      ...
      ['Ho solo un problema piccolo con la porta della mia camera.', 'I just have a small problem with the door of my room.'],
  ...
  },
  {
    ...
    sentences: [
      ['Il prezzo totale è di quindici euro e cinquanta centesimi.', 'The total price is fifteen euros and fifty cents.'],
      ['Può farmi il cambio per una banconota da cinquanta euro?', 'Can you give me change for a fifty-euro banknote?'],
      ...
      ['Questo ristorante è molto buono, ma purtroppo è troppocaro.', 'This restaurant is very good, but unfortunately it is too expensive.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Andrò in vacanza in Italia la prossima settimana.', 'I will go on vacation to Italy next week.'],
  ...
  },
  {
    ...
    sentences: [
      ['Mi dispiace tanto, ho fatto un errore nella prenotazione.', 'I am so sorry, I made a mistake in the reservation.'],
      ...
      ['Ti prego di correggere questo piccolo errore sul documento.', 'Please correct this small mistake on the document.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Il coniglio mangia una carota fresca dal giardino.', 'The rabbit eats a fresh carrot from the garden.'],
      ['La bambina guarda una grande farfalla colorata sui fiori.', 'The little girl looks at a large colorful butterfly on the flowers.']
    ]
  },
  {
    id: 112,
    ...
    sentences: [
      ...
      ['Domani andiamo a visitare il museo d\'arte moderna in centro.', 'Tomorrow we are going to visit the modern art museum downtown.'],
  ...
  },
  {
    ...
    sentences: [
      ...
      ['Domani mattina devo partire presto per il mio lungo viaggio.', 'Tomorrow morning I have to leave early for my long trip.'],
...
const allBlueprints = [...part1, ...part2, ...part3, ...part4];
